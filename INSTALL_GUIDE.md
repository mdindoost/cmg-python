...
bashpip install git+https://github.com/mdindoost/cmg-python.git
...
"No module named 'cmg'": Ensure installation completed successfully
Import errors: Check Python version (3.6+ required)
Performance issues: Install with pip install git+https://github.com/mdindoost/cmg-python.git[fast] for optimized dependencies
